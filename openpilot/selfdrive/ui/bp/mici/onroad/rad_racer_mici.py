...
Same scene as the COMMA_HARDWARE theme (sky, stars, skyline, roadside signs, car sprites) rescaled
...
class RadRacerThemeMici(RadRacerTheme):
  # ~0.25x of the COMMA_HARDWARE 2160x1080 values (see RadRacerTheme class attributes)
