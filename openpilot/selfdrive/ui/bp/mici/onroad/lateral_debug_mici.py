...
vs carState.steeringAngleDeg (actual). Reuses the COMMA_HARDWARE TimeSeriesGraph infrastructure.
...
# Match COMMA_HARDWARE debug panel update rate
  ...
  def __init__(self, back_callback):
    ...
    self._graph = TimeSeriesGraph(
      config=GraphConfig(
        ...
        legend_y_offset=-20,
        # MICI's screen is smaller than COMMA_HARDWARE's -- half-size beads so they don't overwhelm the line.
        marker_radius=4.5,
      ),
      series=[
