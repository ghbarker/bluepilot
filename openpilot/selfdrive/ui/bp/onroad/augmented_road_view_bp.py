...
class AugmentedRoadViewBP(CameraViewBP, AugmentedRoadView, BlindspotRendererMixin):
  ...
  BLIND_SPOT_WIDTH = 250  # Wider for COMMA_HARDWARE's larger screen
  ...
  def update_fade_out_bottom_overlay(self, _content_rect):
    """BluePilot: Skip MICI fade overlay on COMMA_HARDWARE — causes unwanted black gradient at bottom."""
    pass
