"""
Rad Racer 8-bit theme renderer for the COMMA_HARDWARE onroad view.
...
class RadRacerTheme:
  ...
  Screen-scale knobs live as class attributes (COMMA_HARDWARE 2160x1080 values here) so device
