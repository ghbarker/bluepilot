    ...
    def do_GET(self):
        ...
        try:
            ...
            if path == '/api/health':
                ...
                try:
                    panel_dir = Path(__file__).parent.parent / 'ui' / 'menus'
                ...
                try:
                    ...
                    if param_exists("CarParams"):
                        try:
                            ...
                            from openpilot.cereal.messaging import log_from_bytes
                            car_params = log_from_bytes(car_params_bytes, car.CarParams)

                            # Add vehicle-specific state
                            state['hasLongitudinalControl'] = car_params.openpilotLongitudinalControl
                            state['hasBlindSpotMonitoring'] = bool(car_params.enableBsm)
                    ...
                    if param_exists("CarParamsSP"):
                        try:
                            ...
                            from openpilot.cereal.messaging import log_from_bytes
                            car_params_sp = log_from_bytes(car_params_sp_bytes, custom.CarParamsSP)
