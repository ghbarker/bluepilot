...
def apply_ford_ext_params(ret: structs.CarParams, CP, car_fw, fingerprint, alpha_long: bool) -> None:
  ...
  # Current LongControl uses zero proportional gain directly; no kpV field remains.
...
def apply_ford_ext_params_sp(ret: structs.CarParamsSP) -> None:
  ...
  # BluePilot: select the Ford extension without reusing longitudinal or pinion bits.
  from opendbc.sunnypilot.car.ford.values_ext import FordSafetyFlagsSP
  ret.safetyParam |= FordSafetyFlagsSP.BLUEPILOT
  # End BluePilot
